...
| `moe_token_dispatcher_use_fp8_alltoall`                | `false`       | v0.2.0  | MoE dispatcher alltoall communication use in FP8 precision.                                         | `megatron.core.transformer.moe.token_dispatcher.MoEAlltoAllTokenDispatcher`                                                                                                                                                                                                                                                                                                           |   It can help lower message size of alltoall communication. Recommend enable it when the EP communication group across the machines.      |
---
