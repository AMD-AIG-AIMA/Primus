...
| `moe_use_fused_router_with_aux_score`   | `false`       | v0.1.0  | Fused router topk and calculation of moe aux loss score. | `megatron.core.transformer.moe.router.TopKRouter`                                                                                                                                                                                                                                                                               | Used to reduce launch overhead of the small kernels in router.         |
